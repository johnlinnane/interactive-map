...
var histSiteLayer = L.layerGroup([
    ...
    L.marker([53.343184, -6.959953], {icon: siteHistIcon}).addTo(map).bindPopup("<b>Pinkeen Road</b><br>        <br><br><img src='img/sites/011pinkeen.jpg'     class='popupImg'/><br><br>" + pinkeenText + "<br>",     {maxHeight: 250}),
    L.marker([53.284727, -6.900387], {icon: siteHistIcon}).addTo(map).bindPopup("<b>Scour Canal Bridge</b>      <br><br><img src='img/sites/020ascour.jpg'      class='popupImg'/><br><img src='img/sites/020bscour.jpg'      class='popupImg'/><br><br>" + scourText       + "<br>", {maxHeight: 250}),
    ...
    L.marker([53.33078, -7.21776],   {icon: siteHistIcon}).addTo(map).bindPopup("<b>Tubberdaly</b>              <br><br><img src='img/sites/012atubberdaly.jpg' class='popupImg'/><br><img src='img/sites/012btubberdaly.jpg' class='popupImg'/><br><img src='img/sites/012ctubberdaly.jpg' class='popupImg'/><br><img src='img/sites/012dtubberdaly.jpg' class='popupImg'/><br><br>" + tubberdalyText + "<br>",  {maxHeight: 250}),
    ...
    L.marker([53.30876, -7.13468],   {icon: siteHistIcon}).addTo(map).bindPopup("<b>Blunt's Corner</b>          <br><br><img src='img/sites/015blunts.jpg'      class='popupImg'/><br><img src='img/sites/015bblunts.jpg'     class='popupImg'/><br><br>" + bluntsText      + "<br>", {maxHeight: 250}),
